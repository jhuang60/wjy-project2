...
jQuery(function($) {
  ...
  $('#form-card').on("submit", function(e) {
    ...
    if (formValidation() === true) {
      ...
      $('.ticket-info.conformation').append('<li class="padding">Please check your email for your ticket information, make sure to have an screenshoot of the qrcode to scan your qrcode at the entrance.</li>');
      $('#previouspage').remove();
